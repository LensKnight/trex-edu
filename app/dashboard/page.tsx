...
export default function DashboardPage() {
  ...
  async function confirmDelete() {
    ...
    try {
      ...
      if (
        deleteTarget.file_url?.includes(
          "/materials/"
        )
      ) {
        fileName =
    ...
    >
      <div className="p-4 md:p-8">
        ...
        <div className="grid grid-cols-3 gap-3 md:gap-6 mb-8 md:mb-12">
          {[
            ...
            <div
              key={stat.label}
              className="shine-effect p-4 md:p-6 rounded-3xl hover:scale-103 transition-all duration-300"
              style={{
                background: cardBg,
              }}
            >
            ...
            <div className="space-y-2 md:space-y-3">
              {leaderboard.map(
                (user, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-2 md:p-3 rounded-2xl"
                    style={{
                      background:
                        noteBg,
                    }}
          ...
          {subjects.map(
            (subject) => {
              ...
              return (
                <div
                  key={subject}
                  className="rounded-3xl overflow-hidden transition-all duration-300 hover:scale-103"
                  style={{
                    background:
                      cardBg2,
                    border,
                ...
                >
                  <button
                    ...
                    className="w-full flex items-center justify-between p-4 md:p-5 transition hover:opacity-80"
                  >
                      ...
                      {subjectNotes.map(
                        (
                          ...
                          <div
                            ...
                            className="p-3 md:p-4 rounded-2xl flex items-center justify-between gap-2"
                            style={{
                              background:
                                noteBg,
                            }}
      ...
      {deleteTarget && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
          <div
            className="p-6 md:p-8 rounded-3xl w-full max-w-sm text-center"
            style={{
              background: darkMode
                ? "#1a0000"
                : "#fff5f5",
